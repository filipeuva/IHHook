...
SetTextForModelNodeTextFunc* SetTextForModelNodeText;
InitMbStageSpotFunc* InitMbStageSpot;
InitPhaseUiFunc* InitPhaseUi;
UpdatePhaseUiFunc* UpdatePhaseUi;
SetNodeVisibilityWrapperFunc* SetNodeVisibilityWrapper;
IsNodeVisibleFunc* IsNodeVisible;
GetUixLayoutFunc* GetUixLayout;
GetModelWrapperFunc* GetModelWrapper;
CreateModelNodeFunc* CreateModelNode;
NewUiModelTextFunc* NewUiModelText;
GetModelNodeFromIndexFunc* GetModelNodeFromIndex;
LoadCreationContextFunc* LoadCreationContext;
SetNodeVisibilityFunc* SetNodeVisibility;
ReadNodeFunc* ReadNode;
InitModelNodeTextFunc* InitModelNodeText;
GetLayoutModelFunc* GetLayoutModel;
SetupModelFunc* SetupModel;
GetCommonNodeFunc* GetCommonNode;
SetTextUnitsForModelNodeTextFunc* SetTextUnitsForModelNodeText;
SetTextUnitsFunc* SetTextUnits;
ConnectLayoutComponentFunc* ConnectLayoutComponent;
SetLayoutParentComponentFunc* SetLayoutParentComponent;
RemoveLayoutChildComponentFunc* RemoveLayoutChildComponent;
OnLayoutComponentDestroyFunc* OnLayoutComponentDestroy;
ConnectChildWindowToRootFunc* ConnectChildWindowToRoot;
NodeConnectShimFunc* NodeConnectShim;
GetGlobalUixUtilityFunc* GetGlobalUixUtility;
