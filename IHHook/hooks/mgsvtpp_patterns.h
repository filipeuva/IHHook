...
namespace IHHook {
	std::map<std::string, std::string> mgsvtpp_patterns{
		...
		{"UpdatePlayerCamo", "48 89 5C 24 20 55 56 57 41 56 41 57 48 8D 6C 24 C9 48 81 EC E0 00 00 00 48 8B 05 ? ? ? ? 48 33 C4 48 89 45 C7 44 8B 41 78 48 8B 42 50 83 CB FF 83 B9 84 00 00 00 4D 46 0F B6 34 00 4C 8B FA 48 8B F1 0F 85 ? ? ? ?"},
		{"ScopeZoomUiUpdate", "48 89 5C 24 08 48 89 74 24 10 57 48 83 EC 20 48 8B 41 50 40 32 F6 48 8B F9 0F B6 98 28 03 00 00 3A 99 20 01 00 00 74 0F F6 C3 01 40 0F B6 F6 B8 01 00 00 00 0F 45 F0 88 99 20 01 00 00 48 8B 49 08 48 8B 01 FF 50 08"},
		{"ScopeZoomUiSetHelpAsset", "48 89 5C 24 08 57 48 83 EC 20 4C 89 C3 48 89 91 58 01 00 00 48 89 CF 48 89 99 60 01 00 00 48 8B 49 60 49 B8 9C 73 8A 42 C2 41 00 00 48 8B 01 FF 90 48 02 00 00 48 8B 4F 60 49 B8 FB 9F A8 1E 57 56 00 00 48 89 87 68 01 00 00 48 8B 01 48 89 DA FF 90 48 02 00 00 48 8B 4F 60 48 8B 97 68 01 00 00 48 89 87 70 01 00 00 48 8B 01 49 B8 C7 35 F1 BB 56 0E 00 00 FF 90 50 02 00 00"},
