...
namespace IHHook {
	std::map<std::string, std::string> mgsvtpp_patterns{
		...
		{"ApplyTextAndMeasure","48 89 5C 24 08 48 89 6C 24 10 48 89 74 24 18 57 48 83 EC 60 0F B6 84 24 90 00 00 00"},
		...
		{"TextUnitBuilder", "40 55 53 56 57 41 54 41 55 41 56 41 57 48 8D AC 24 C8 CE FF FF B8 38 32 00 00 E8 ? ? ? ? 48 2B E0 48 C7 45 30 FE FF FF FF 0F 29 B4 24 20 32 00 00 0F 29 BC 24 10 32 00 00 44 0F 29 84 24 00 32 00 00 44 0F 29 8C 24 F0 31 00 00 44 0F 29 94 24 E0 31 00 00 44 0F 29 9C 24 D0 31 00 00 44 0F 29 A4 24 C0 31 00 00 44 0F 29 AC 24 B0 31 00 00 48 8B 05 ? ? ? ? 48 33 C4 48 89 85 A0 30 00 00 44 89 4D 98 4C 89 45 20 48 89 55 E0 48 8B F1"}
